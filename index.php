    ...
    <main>
      ...
      <div id="Introduction-wrapper" class="fadein">
        <div class="container">
          <div class="inner">
            <h2>はじめに</h2>
            <div class="intro">このサイトでは、<span>「ヤバい集中力:鈴木祐（著）」</span>という本のタスク管理法を使ってあなたの集中力を最大にします。集中力を最大限に発揮することで得られる効果はいうまでもなく絶大なものです。集中すれば1時間で終わる作業も「スマホに気を取られて30分無駄いしてしまった、、、」ということが少なくないでしょう。一日の始まりや一日の終わりにタスクを設定して「スマホをいじってしまう」、「作業に集中できない」、「やらなければならない仕事を先延ばしにしてしまう」といった悩みを解消しましょう。</div>
          </div>
        </div>
      </div>
      <div id="about-wrapper" class="fadein">
        <div class="container">
          <div class="inner">
            <h2>報酬感覚プランニング</h2>
            <p>「報酬感覚プランニング」とは、1970年代からの研究で生まれた大量の集中力に関する対策のから特に効果が高いものを厳選したワークシートです。このワークシートは、大きく分けて3つあります。中長期的な目標を改めて確認してデイリータスクを絞り込む<span>「基本設定シート」</span>、絞り込んだデイリータスクをこなすための毎日使う<span>「実践設定シート」</span>、短期的な作業に取り組むための<span>「即効簡易版シート」</span>の3つです。</p>
          </div>
        </div>
      </div>
      <div id="guide" class="fadein">
        <div class="container">
